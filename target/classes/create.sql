...
DROP TABLE ANALYTIC IF EXISTS CASCADE;
...
(
    ...
    TIME INT NOT NULL,
    USERNAME VARCHAR(50) not null
        constraint ANALYTIC_USERNAME_JWT_USERNAME_FK
            references JWT_USER (USERNAME)
);
...
--Advertiser Inserts
INSERT INTO ADVERTISER (USERNAME,COMPANY_NAME,AD_AMNT,PRICE_PER_AD,DISPLAY)
VALUES ('advertiser','Talabat',0,0,"N");
